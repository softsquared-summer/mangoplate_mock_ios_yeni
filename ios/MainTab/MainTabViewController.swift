...
//    var firstTabImage: UIImage = UIImage(named: "firstItem_gray")!
    ...
    FindingGoodRestaurant.tabBarItem.image?.withAlignmentRectInsets(UIEdgeInsets(top: 0, left: 15, bottom: 0, right: 0))//Give your left alignment number

    FindingGoodRestaurant.tabBarItem.imageInsets = UIEdgeInsets(top: 0, left: 40, bottom: 0, right: 0)
    ...
    MangoPick.tabBarItem.image?.withAlignmentRectInsets(UIEdgeInsets(top: 0, left: 15, bottom: 0, right: 0))//Give your left alignment number
    MangoPick.tabBarItem.imageInsets = UIEdgeInsets(top: 0, left: 70, bottom: 0, right: 0)
...
//    Plus.tabBarItem = UITabBarItem(title: nil, image: UIImage(named: "ic_addition_square_orange.png"), selectedImage: UIImage(named: "ic_addition_square_orange.png"))
 Plus.tabBarItem.image?.withAlignmentRectInsets(UIEdgeInsets(top: 0, left: 15, bottom: 0, right: 0))//Give your left alignment number
        Plus.tabBarItem.imageInsets = UIEdgeInsets(top: 9, left: 50, bottom: 0, right: 0)
...
//    plusButton.setImage(UIImage(named: "ic_addition_square_orange"), for: .normal)
    ...
    News.tabBarItem.image?.withAlignmentRectInsets(UIEdgeInsets(top: 0, left: 15, bottom: 0, right: 0))//Give your left alignment number
    News.tabBarItem.imageInsets = UIEdgeInsets(top: 0, left: 60, bottom: 0, right: 0)
    ...
    MyInfo.tabBarItem.image?.withAlignmentRectInsets(UIEdgeInsets(top: 0, left: 15, bottom: 0, right: 0))//Give your left alignment number
    MyInfo.tabBarItem.imageInsets = UIEdgeInsets(top: 5, left: 55, bottom: 0, right: 0)
...
//    tabBarItem.imageInsets = UIEdgeInsets(top: 9, left: 0, bottom: -9, right: 0)
    ...
    override func viewDidLayoutSubviews() {
        ...
        plusButton.frame = CGRect.init(x: self.tabBar.center.x, y: self.view.bounds.height - 80, width: 44, height: 44)
